...
// Operator hours, derived from capture activity. Lifted out of its own Hub tab
// and into a panel: hours are a fact ABOUT the team, so it lives on the Team tab
// next to the capture ratings rather than as a seventh top-level tab. The logic
// is unchanged from /supervisor/timesheets — only the page chrome was removed.
