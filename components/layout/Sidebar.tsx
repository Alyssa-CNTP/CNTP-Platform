...
const NAV: NavItem[] = [
  ...
  // Maintenance — own section. Full module is Maintenance + Management (+ IT).
  // Production sees ONLY Job Cards (to report breakdowns + track their own cards).
  { href: '/maintenance',               label: 'Dashboard',                  icon: LayoutDashboard, group: 'Maintenance', departments: ['IT','Maintenance','Management'] },
  { href: '/maintenance/job-cards',      label: 'Job Cards',                  icon: ClipboardList,   group: 'Maintenance', departments: ['IT','Maintenance','Management','Production'] },
  { href: '/maintenance/scheduled',      label: 'Scheduled',                  icon: CalendarCheck,   group: 'Maintenance', departments: ['IT','Maintenance','Management'] },
  { href: '/maintenance/planner',        label: 'Planner & Roster',           icon: CalendarRange,   group: 'Maintenance', departments: ['IT','Maintenance','Management'] },
  { href: '/maintenance/stock',          label: 'Stock & Spares',             icon: Boxes,           group: 'Maintenance', departments: ['IT','Maintenance','Management'] },
