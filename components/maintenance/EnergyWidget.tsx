...
// Energy dashboard: hourly usage + solar production charts (Recharts) and a
// Sources breakdown table. Data pulled from /api/maintenance/energy every 5 min.
    ...
    return (
      <div className="card p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-semibold text-text">Energy Today</span>
        </div>
