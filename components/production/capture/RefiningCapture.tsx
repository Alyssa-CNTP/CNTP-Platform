...
export function RefiningCapture({
  ...
  // +/-1% of Total Input. This replaced a flat 15 kg, and a 100 kg special
  // case for refining2 that existed because that line runs bigger volumes --
  // which is exactly what a percentage handles without a special case.
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              {!withinTol && (
                <span className="flex items-center gap-1 text-[11px] font-medium text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full">
                  <AlertTriangle size={12} /> Outside ±{balanceTolKg.toFixed(1)} kg (1%)
                </span>
              )}
            </div>
