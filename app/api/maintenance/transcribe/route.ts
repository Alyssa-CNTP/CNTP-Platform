...
// The voice prompt must offer the SAME maintenance types as the form. This was a
// second hand-maintained copy of the list, so a type added to the form was
// unreachable by voice until someone remembered to edit it here too.
