...
// from the caller's own Staff Directory record, never accepted from the
// client. Mirrors the Pasteuriser job card's quality-sign route exactly,
// targeting job_cards_granule instead.
