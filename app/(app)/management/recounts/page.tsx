...
// ── Recount review card — TOP LEVEL to prevent remount on re-render ───────────
    ...
    <div className={`bg-surface-card border rounded-2xl overflow-hidden ${
      ...
      {open && (
        <div className="border-t border-surface-rule px-5 pb-5 pt-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              {showPhoto && (
                <div className="rounded-xl overflow-hidden border border-surface-rule max-w-sm">
                  ...
                  <img
                    src={`data:${req.photo_mime};base64,${req.photo_base64}`}
                    alt="Recount evidence"
          ...
          {/* Admin response + actions — only for pending */}
          {req.status === 'pending' && (
            <div className="space-y-3">
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  placeholder="e.g. Accepted — supervisor recount confirmed correct. Admin miscounted the back pallet."
                  rows={2}
...
// ── Recount review page ───────────────────────────────────────────────────────
export default function RecountReviewPage() {
  ...
  return (
    <div className="px-6 py-6 space-y-5 max-w-[800px]">

      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-display font-bold text-[22px] text-text">Recount review</h1>
