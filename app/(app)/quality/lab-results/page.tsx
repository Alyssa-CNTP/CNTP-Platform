          ...
          {current.length > 0 && (
            <button
              onClick={() => {
                ...
                const rows2 = allRows.map((r:any)=>[r.batch_no??'',...cols2.map(([k])=>r[k]??''),r.created_at?new Date(r.created_at).toLocaleString('en-ZA',{day:'2-digit',month:'short',year:'numeric',hour:'2-digit',minute:'2-digit',hour12:false}):''])
