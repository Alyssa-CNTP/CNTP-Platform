...
const ROUTE_META: Record<string, {
  ...
  '/production/staff/matrix':{ title: 'Skills Matrix',           variant: 'default', chips: [{ label: 'Operations', color: 'green' }] },
  '/production/staff/sops':  { title: 'SOP Catalogue',           variant: 'default', chips: [{ label: 'Operations', color: 'green' }] },
    ...
    <LanguageProvider>
      <div className="flex h-dvh overflow-hidden bg-surface app-shell">
        ...
        <div className="flex flex-col flex-1 min-w-0 overflow-hidden app-shell-col">
          ...
          />
          <main className="flex-1 overflow-y-auto overflow-x-hidden app-shell-main page-content">
            {children}
          </main>
        </div>
        <CommandSearch />
