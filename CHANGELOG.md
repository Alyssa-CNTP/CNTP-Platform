...
## 2026-08-14 — Alyssa (Camera scanner: iOS decoder failure was reported as a camera failure — promoted to production)
...
- Note: this and the original camera-scanner PR (#649) did not actually reach the live staging site until a separate CI fix (#653, deploy script was silently succeeding on failed builds) landed the same day — see the camera-scanning entry further down.
