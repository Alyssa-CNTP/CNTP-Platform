...
- **Database structure alignment now complete** (qms, maintenance, acumatica, production, axis, shared, workspace). Next: first-time production app deploy. Deferred: retire old `public.*` blob quality tables.
